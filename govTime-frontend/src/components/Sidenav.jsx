  ...
  return (
    <div className="sidenav h-full ">
        ...
        <div className="sidenav-list fixed left-0 top-0 flex justify-left flex-col items-center gap-15 bg-[#0b1b4f] h-full w-[15%] ml-0  pl-2 text-white text-[20px] " >
            ...
            <div className="button-icon flex jsustify-center items-center gap-3 hover:cursor-pointer duration-1000 py-2 hover:bg-[#ffffff3f] w-full rounded-md">
            ...
            <Link to="/appointments" className="sidenav-link ">Appointments</Link>
            </div>
            <div className="button-icon flex jsustify-center items-center gap-3 hover:cursor-pointer  duration-1000 py-2  hover:bg-[#ffffff3f] w-full rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                <path strokeLinecap="round" strokeLinejoin="round" d="M14.857 17.082a23.848 23.848 0 0 0 5.454-1.31A8.967 8.967 0 0 1 18 9.75V9A6 6 0 0 0 6 9v.75a8.967 8.967 0 0 1-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 0 1-5.714 0m5.714 0a3 3 0 1 1-5.714 0M3.124 7.5A8.969 8.969 0 0 1 5.292 3m13.416 0a8.969 8.969 0 0 1 2.168 4.5" />
                </svg>
            <Link to="/notification" className="sidenav-link ">Notification</Link>
            </div>
